...
const ShoesPopup = ({ isOpen, onClose, item }) => {
      ...
      <div className="relative p-4 w-full max-w-4xl max-h-full">
        <div className="relative bg-slate-100 rounded-lg shadow">
          <div className="flex flex-wrap sm:flex-nowrap md:flex-nowrap justify-between items-center gap-5 p-6">
            <div className="img">
              <img className="w-[100rem] object-cover h-full shadow-xl bg-white" src={`img/product/shoes/${item.img}`} alt="" />
            </div>
            ...
            <div className="flex flex-col  p-4 md:p-5">
              ...
              <h1 className="text-2xl font-bold">{item.price} THB</h1>
            </div>
          </div>
